...
class MyTinderSwapCard extends StatefulWidget {
...
//  double _minHeight;
  ...
  @override
  _MyTinderSwapCardState createState() => _MyTinderSwapCardState();
...
class _MyTinderSwapCardState extends State<MyTinderSwapCard>
...
class CardAnimation {
  static Animation<Alignment> frontCardAlign(AnimationController controller,
    ...
    if (_MyTinderSwapCardState._trigger == 0) {
      endX = beginAlign.x > 0
      ...
      endY = beginAlign.x > 3.0 || beginAlign.x < -swipeEdge
          ? beginAlign.y
          : baseAlign.y;
    } else if (_MyTinderSwapCardState._trigger == -1) {
