...
class LightColor {
  ...
  static Color getSerialColor() {
    List<Color> colors = [yellow, lightBlue, darkOrange, darkpurple];
    _index++;
    return colors[(_index) % colors.length];
  }

  static Color getALightColor() {
    List<Color> colors = [
      lightBlue,
      lightblack,
      lightGrey,
  ...
  static Color _getOneColor(List<Color> colors) {
